...
var author$project$Board$placePiece = F4(
	function (row, column, piece, board) {
		var _n0 = A3(tortus$elm_array_2d$Array2D$get, row, column, board);
		if (_n0.$ === 'Just') {
			var cell = _n0.a;
			return A4(
				...
				_Utils_update(
					cell,
					{
						piece: elm$core$Maybe$Just(piece)
					}),
				board);
		} else {
			return board;
...
var author$project$Board$placePieces = function (board) {
	return A4(
		author$project$Board$placePiece,
		1,
		7,
		{color: author$project$Piece$Black, kind: author$project$Piece$Pawn},
		A4(
			author$project$Board$placePiece,
			1,
			6,
							...
							A4(
								...
								A4(
									...
									A4(
										...
										0,
										7,
										{color: author$project$Piece$Black, kind: author$project$Piece$Rook},
										A4(
											author$project$Board$placePiece,
											0,
											6,
											{color: author$project$Piece$Black, kind: author$project$Piece$Knight},
											A4(
												author$project$Board$placePiece,
												0,
												5,
												{color: author$project$Piece$Black, kind: author$project$Piece$Bishop},
												A4(
													author$project$Board$placePiece,
													0,
													4,
													{color: author$project$Piece$Black, kind: author$project$Piece$King},
													A4(
														author$project$Board$placePiece,
														0,
														3,
														{color: author$project$Piece$Black, kind: author$project$Piece$Queen},
														A4(
															author$project$Board$placePiece,
															0,
															2,
															...
															A4(
																...
																A4(
																	...
																	A4(
																		...
																		6,
																		7,
																		{color: author$project$Piece$White, kind: author$project$Piece$Pawn},
																		A4(
																			author$project$Board$placePiece,
																			6,
																			6,
																							...
																							A4(
																								...
																								A4(
																									...
																									A4(
																										...
																										7,
																										7,
																										{color: author$project$Piece$White, kind: author$project$Piece$Rook},
																										A4(
																											author$project$Board$placePiece,
																											7,
																											6,
																											{color: author$project$Piece$White, kind: author$project$Piece$Knight},
																											A4(
																												author$project$Board$placePiece,
																												7,
																												5,
																												{color: author$project$Piece$White, kind: author$project$Piece$Bishop},
																												A4(
																													author$project$Board$placePiece,
																													7,
																													4,
																													{color: author$project$Piece$White, kind: author$project$Piece$King},
																													A4(
																														author$project$Board$placePiece,
																														7,
																														3,
																														{color: author$project$Piece$White, kind: author$project$Piece$Queen},
																														A4(
																															author$project$Board$placePiece,
																															7,
																															2,
...
var author$project$Board$setCoordinate = F3(
...
var author$project$Board$initial = author$project$Board$placePieces(
	A2(
		tortus$elm_array_2d$Array2D$indexedMap,
		author$project$Board$setCoordinate,
		A3(
			tortus$elm_array_2d$Array2D$repeat,
			8,
			8,
			{column: 0, piece: elm$core$Maybe$Nothing, row: 0})));
...
var author$project$Main$init = function (_n0) {
	var _n1 = A2(elm$core$Debug$log, 'msg', author$project$Board$initial);
	return _Utils_Tuple2(
		{board: author$project$Board$initial, state: author$project$Main$Initial},
		elm$core$Platform$Cmd$none);
};
var author$project$Board$addPiece = F3(
	function (cell, piece, board) {
		return A4(
			tortus$elm_array_2d$Array2D$set,
			cell.row,
			cell.column,
...
var author$project$Board$movePiece = F3(
	function (from, to, board) {
		...
		if (_n0.$ === 'Just') {
			var piece = _n0.a;
			return A3(
				author$project$Board$addPiece,
				to,
				piece,
				A2(author$project$Board$removePiece, from, board));
		} else {
			return board;
		}
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		var cell = msg.a;
		var _n2 = _Utils_Tuple2(model.state, cell.piece);
		if (_n2.a.$ === 'Initial') {
			if (_n2.b.$ === 'Just') {
				var _n3 = _n2.a;
				var piece = _n2.b.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: author$project$Main$Selected(cell)
						}),
					elm$core$Platform$Cmd$none);
			} else {
				var _n4 = _n2.a;
			...
			if (_n2.b.$ === 'Nothing') {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							board: A3(author$project$Board$movePiece, c, cell, model.board)
						}),
					elm$core$Platform$Cmd$none);
			} else {
				var c = _n2.a.a;
...
var author$project$Main$size = 80;
var author$project$Piece$render = function (_n0) {
	var kind = _n0.kind;
	var color = _n0.color;
	var _n1 = _Utils_Tuple2(kind, color);
	if (_n1.b.$ === 'Black') {
		switch (_n1.a.$) {
			case 'King':
				var _n2 = _n1.a;
	...
	function (state, cell) {
		var label = function () {
			...
			if (_n1.$ === 'Just') {
				...
				return elm$core$String$fromChar(
					author$project$Piece$render(piece));
			} else {
				return '';
			}
		}();
		var color = function () {
			if (state.$ === 'Initial') {
				...
				var selectedCell = state.a;
				return _Utils_eq(cell, selectedCell) ? A3(rtfeldman$elm_css$Css$rgb, 255, 0, 0) : A3(rtfeldman$elm_css$Css$rgb, 255, 255, 255);
			}
		}();
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$px(author$project$Main$size)),
					...
					author$project$Main$Click(cell))
				]),
			_List_fromArray(
				[
	...
	function (state, row) {
		return A2(
			...
			elm$core$Array$toList(
				A2(
					elm$core$Array$map,
					author$project$Main$renderCell(state),
					row)));
	});
	...
	function (state, board) {
		return A2(
			...
			elm$core$Array$toList(
				A2(
					elm$core$Array$map,
					author$project$Main$renderRow(state),
					board.data)));
	});
var author$project$Main$view = function (model) {
	return A2(author$project$Main$render, model.state, model.board);
};
